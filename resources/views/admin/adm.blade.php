...
<a class="no-underline" href="{{route('admin.index')}}">Posts</a>
<a class="no-underline" href="{{route('posts.create')}}">criar post</a>
<a class="no-underline"  href="{{route('admin.tabela')}}">Tabela de usúarios</a>
<a class="no-underline"  href="/dashboard_admin ">Meus posts</a>  
<a class="no-underline"  href="/dashboard_user">Menu comum</a>  
}
@endif
